...
country_codes = [
    ...
    ('+994', 'Azerbaïdjan (+994)'), ('+1242', 'Bahamas (+1242)'), ('+973', 'Bahreïn (+973)'),
    ('+880', 'Bangladesh (+880)'), ('+1246', 'Barbade (+1246)'), ('+375', 'Biélorussie (+375)'),
    ('+32', 'Belgique (+32)'), ('+501', 'Belize (+501)'), ('+229', 'Bénin (+229)'), ('+1441', 'Bermudes (+1441)'),
    ('+975', 'Bhoutan (+975)'), ('+591', 'Bolivie (+591)'), ('+387', 'Bosnie-Herzégovine (+387)'),
    ('+267', 'Botswana (+267)'), ('+55', 'Brésil (+55)'),
    ('+246', 'Territoire britannique de l\'océan Indien (+246)'),
    ('+1284', 'Îles Vierges britanniques (+1284)'), ('+673', 'Brunéi Darussalam (+673)'),
    ('+359', 'Bulgarie (+359)'), ('+226', 'Burkina Faso (+226)'), ('+257', 'Burundi (+257)'),
    ('+855', 'Cambodge (+855)'), ('+237', 'Cameroun (+237)'), ('+1', 'Canada (+1)'),
    ('+238', 'Cap-Vert (+238)'), ('+1345', 'Îles Caïmans (+1345)'),
    ('+236', 'République centrafricaine (+236)'), ('+235', 'Tchad (+235)'), ('+56', 'Chili (+56)'),
    ('+86', 'Chine (+86)'), ('+61', 'Île Christmas (+61)'), ('+61', 'Îles Cocos (Keeling) (+61)'),
    ('+57', 'Colombie (+57)'), ('+269', 'Comores (+269)'), ('+243', 'Congo (RDC) (+243)'),
    ('+242', 'Congo (République) (+242)'), ('+682', 'Îles Cook (+682)'), ('+506', 'Costa Rica (+506)'),
    ('+225', 'Côte d\'Ivoire (+225)'), ('+385', 'Croatie (+385)'), ('+53', 'Cuba (+53)'),
    ('+599', 'Curaçao (+599)'), ('+357', 'Chypre (+357)'), ('+420', 'République tchèque (+420)'),
    ('+45', 'Danemark (+45)'), ('+253', 'Djibouti (+253)'), ('+1767', 'Dominique (+1767)'),
    ('+1809', 'République dominicaine (+1809)'), ('+593', 'Équateur (+593)'), ('+20', 'Égypte (+20)'),
    ('+503', 'El Salvador (+503)'), ('+240', 'Guinée équatoriale (+240)'), ('+291', 'Érythrée (+291)'),
    ('+372', 'Estonie (+372)'), ('+268', 'Eswatini (+268)'), ('+251', 'Éthiopie (+251)'),
    ('+500', 'Îles Malouines (+500)'), ('+298', 'Îles Féroé (+298)'), ('+679', 'Fidji (+679)'),
    ('+358', 'Finlande (+358)'), ('+33', 'France (+33)'), ('+594', 'Guyane française (+594)'),
    ('+689', 'Polynésie française (+689)'), ('+241', 'Gabon (+241)'), ('+220', 'Gambie (+220)'),
    ('+995', 'Géorgie (+995)'), ('+49', 'Allemagne (+49)'), ('+233', 'Ghana (+233)'),
    ('+350', 'Gibraltar (+350)'), ('+30', 'Grèce (+30)'), ('+299', 'Groenland (+299)'),
    ('+1473', 'Grenade (+1473)'), ('+590', 'Guadeloupe (+590)'), ('+1671', 'Guam (+1671)'),
    ('+502', 'Guatemala (+502)'), ('+44', 'Guernesey (+44)'), ('+224', 'Guinée (+224)'),
    ('+245', 'Guinée-Bissau (+245)'), ('+592', 'Guyana (+592)'), ('+509', 'Haïti (+509)'),
    ('+504', 'Honduras (+504)'), ('+852', 'Hong Kong (+852)'), ('+36', 'Hongrie (+36)'),
    ('+354', 'Islande (+354)'), ('+91', 'Inde (+91)'), ('+62', 'Indonésie (+62)'), ('+98', 'Iran (+98)'),
    ('+964', 'Irak (+964)'), ('+353', 'Irlande (+353)'), ('+44', 'Île de Man (+44)'),
    ('+972', 'Israël (+972)'), ('+39', 'Italie (+39)'), ('+1876', 'Jamaïque (+1876)'),
    ('+81', 'Japon (+81)'), ('+44', 'Jersey (+44)'), ('+962', 'Jordanie (+962)'), ('+7', 'Kazakhstan (+7)'),
    ('+254', 'Kenya (+254)'), ('+686', 'Kiribati (+686)'), ('+850', 'Corée du Nord (+850)'),
    ('+82', 'Corée du Sud (+82)'), ('+383', 'Kosovo (+383)'), ('+965', 'Koweït (+965)'),
    ('+996', 'Kirghizistan (+996)'), ('+856', 'Laos (+856)'), ('+371', 'Lettonie (+371)'),
    ('+961', 'Liban (+961)'), ('+266', 'Lesotho (+266)'), ('+231', 'Libéria (+231)'),
    ('+218', 'Libye (+218)'), ('+423', 'Liechtenstein (+423)'), ('+370', 'Lituanie (+370)'),
    ('+352', 'Luxembourg (+352)'), ('+853', 'Macao (+853)'), ('+261', 'Madagascar (+261)'),
    ('+265', 'Malawi (+265)'), ('+60', 'Malaisie (+60)'), ('+960', 'Maldives (+960)'),
    ('+223', 'Mali (+223)'), ('+356', 'Malte (+356)'), ('+692', 'Îles Marshall (+692)'),
    ('+596', 'Martinique (+596)'), ('+222', 'Mauritanie (+222)'), ('+230', 'Maurice (+230)'),
    ('+262', 'Mayotte (+262)'), ('+52', 'Mexique (+52)'), ('+691', 'Micronésie (+691)'),
    ('+373', 'Moldavie (+373)'), ('+377', 'Monaco (+377)'), ('+976', 'Mongolie (+976)'),
    ('+382', 'Monténégro (+382)'), ('+1664', 'Montserrat (+1664)'), ('+212', 'Maroc (+212)'),
    ('+258', 'Mozambique (+258)'), ('+95', 'Myanmar (Birmanie) (+95)'), ('+264', 'Namibie (+264)'),
    ('+674', 'Nauru (+674)'), ('+977', 'Népal (+977)'), ('+31', 'Pays-Bas (+31)'),
    ('+687', 'Nouvelle-Calédonie (+687)'), ('+64', 'Nouvelle-Zélande (+64)'), ('+505', 'Nicaragua (+505)'),
    ('+227', 'Niger (+227)'), ('+234', 'Nigéria (+234)'), ('+683', 'Niue (+683)'),
    ('+672', 'Île Norfolk (+672)'), ('+389', 'Macédoine du Nord (+389)'),
    ('+1670', 'Îles Mariannes du Nord (+1670)'), ('+47', 'Norvège (+47)'), ('+968', 'Oman (+968)'),
    ('+92', 'Pakistan (+92)'), ('+680', 'Palaos (+680)'), ('+970', 'Palestine (+970)'),
    ('+507', 'Panama (+507)'), ('+675', 'Papouasie-Nouvelle-Guinée (+675)'), ('+595', 'Paraguay (+595)'),
    ('+51', 'Pérou (+51)'), ('+63', 'Philippines (+63)'), ('+48', 'Pologne (+48)'),
    ('+351', 'Portugal (+351)'), ('+1', 'Porto Rico (+1)'), ('+974', 'Qatar (+974)'),
    ('+262', 'Réunion (+262)'), ('+40', 'Roumanie (+40)'), ('+7', 'Russie (+7)'), ('+250', 'Rwanda (+250)'),
    ('+590', 'Saint-Barthélemy (+590)'), ('+290', 'Sainte-Hélène (+290)'),
    ('+1869', 'Saint-Kitts-et-Nevis (+1869)'), ('+1758', 'Sainte-Lucie (+1758)'),
    ('+590', 'Saint-Martin (+590)'), ('+508', 'Saint-Pierre-et-Miquelon (+508)'),
    ('+1784', 'Saint-Vincent-et-les Grenadines (+1784)'), ('+685', 'Samoa (+685)'),
    ('+378', 'Saint-Marin (+378)'), ('+239', 'Sao Tomé-et-Principe (+239)'),
    ('+966', 'Arabie Saoudite (+966)'), ('+221', 'Sénégal (+221)'), ('+381', 'Serbie (+381)'),
    ('+248', 'Seychelles (+248)'), ('+232', 'Sierra Leone (+232)'), ('+65', 'Singapour (+65)'),
    ('+1721', 'Sint Maarten (+1721)'), ('+421', 'Slovaquie (+421)'), ('+386', 'Slovénie (+386)'),
    ('+677', 'Îles Salomon (+677)'), ('+252', 'Somalie (+252)'), ('+27', 'Afrique du Sud (+27)'),
    ('+211', 'Soudan du Sud (+211)'), ('+34', 'Espagne (+34)'), ('+94', 'Sri Lanka (+94)'),
    ('+249', 'Soudan (+249)'), ('+597', 'Suriname (+597)'), ('+46', 'Suède (+46)'),
    ('+41', 'Suisse (+41)'), ('+963', 'Syrie (+963)'), ('+886', 'Taïwan (+886)'),
    ('+992', 'Tadjikistan (+992)'), ('+255', 'Tanzanie (+255)'), ('+66', 'Thaïlande (+66)'),
    ('+670', 'Timor oriental (+670)'), ('+228', 'Togo (+228)'), ('+690', 'Tokelau (+690)'),
    ('+676', 'Tonga (+676)'), ('+1868', 'Trinité-et-Tobago (+1868)'), ('+216', 'Tunisie (+216)'),
    ('+90', 'Turquie (+90)'), ('+993', 'Turkménistan (+993)'),
    ('+1649', 'Îles Turques-et-Caïques (+1649)'), ('+688', 'Tuvalu (+688)'),
    ('+1340', 'Îles Vierges américaines (+1340)'), ('+256', 'Ouganda (+256)'), ('+380', 'Ukraine (+380)'),
    ('+971', 'Émirats arabes unis (+971)'), ('+44', 'Royaume-Uni (+44)'), ('+598', 'Uruguay (+598)'),
    ('+998', 'Ouzbékistan (+998)'), ('+678', 'Vanuatu (+678)'), ('+379', 'Vatican (+379)'),
    ('+58', 'Venezuela (+58)'), ('+84', 'Viêt Nam (+84)'), ('+681', 'Wallis-et-Futuna (+681)'),
    ('+212', 'Sahara occidental (+212)'), ('+967', 'Yémen (+967)'), ('+260', 'Zambie (+260)'),
    ('+263', 'Zimbabwe (+263)')
]
