...
country_codes = [
    ...
    ('+355', 'Albanie (+355)'),
    ('+213', 'Algérie (+213)'),
    ('+1684', 'Samoa américaines (+1684)'),
    ('+376', 'Andorre (+376)'),
    ('+244', 'Angola (+244)'),
    ('+1264', 'Anguilla (+1264)'),
    ('+1268', 'Antigua-et-Barbuda (+1268)'),
    ('+54', 'Argentine (+54)'),
    ('+374', 'Arménie (+374)'),
    ('+297', 'Aruba (+297)'),
    ('+61', 'Australie (+61)'),
    ...
    ('+1284', 'Îles Vierges britanniques (+1284)'),
    ('+673', 'Brunéi Darussalam (+673)'),
    ('+359', 'Bulgarie (+359)'),
    ...
    ('+1', 'Canada (+1)'),
    ('+238', 'Cap-Vert (+238)'),
    ('+1345', 'Îles Caïmans (+1345)'),
    ('+236', 'République centrafricaine (+236)'),
    ('+235', 'Tchad (+235)'),
    ('+56', 'Chili (+56)'),
    ('+86', 'Chine (+86)'),
    ('+61', 'Île Christmas (+61)'),
    ('+61', 'Îles Cocos (Keeling) (+61)'),
    ('+57', 'Colombie (+57)'),
    ('+269', 'Comores (+269)'),
    ('+243', 'Congo (RDC) (+243)'),
    ('+242', 'Congo (République) (+242)'),
    ('+682', 'Îles Cook (+682)'),
    ('+506', 'Costa Rica (+506)'),
    ...
    ('+253', 'Djibouti (+253)'),
    ('+1767', 'Dominique (+1767)'),
    ('+1809', 'République dominicaine (+1809)'), # Aussi +1-829, +1-849
    ('+593', 'Équateur (+593)'),
    ('+20', 'Égypte (+20)'),
    ('+503', 'El Salvador (+503)'),
    ...
    ('+1670', 'Îles Mariannes du Nord (+1670)'),
    ('+47', 'Norvège (+47)'),
    ('+968', 'Oman (+968)'),
    ('+92', 'Pakistan (+92)'),
    ('+680', 'Palaos (+680)'),
    ...
    ('+1869', 'Saint-Kitts-et-Nevis (+1869)'),
    ('+1758', 'Sainte-Lucie (+1758)'),
    ('+590', 'Saint-Martin (+590)'),
    ('+508', 'Saint-Pierre-et-Miquelon (+508)'),
    ('+1784', 'Saint-Vincent-et-les Grenadines (+1784)'),
    ('+685', 'Samoa (+685)'),
    ('+378', 'Saint-Marin (+378)'),
    ...
    ('+690', 'Tokelau (+690)'),
    ('+676', 'Tonga (+676)'),
    ('+1868', 'Trinité-et-Tobago (+1868)'),
    ('+216', 'Tunisie (+216)'),
    ('+90', 'Turquie (+90)'),
    ('+993', 'Turkménistan (+993)'),
    ('+1649', 'Îles Turques-et-Caïques (+1649)'),
    ('+688', 'Tuvalu (+688)'),
    ('+1340', 'Îles Vierges américaines (+1340)'),
    ('+256', 'Ouganda (+256)'),
    ('+380', 'Ukraine (+380)'),
