# migrations/versions/96ab9fccb07e_rebuild_initial_schema_for_all_current_models.py
"""Rebuild initial schema for all current models

Revision ID: 96ab9fccb07e
Revises: 
Create Date: 2025-05-13 15:13:30.912922
"""
...
def upgrade():
    ...
    sa.Column('is_active', sa.Boolean(), nullable=False, server_default=sa.false()), # MODIFIED
    sa.Column('uploaded_at', sa.DateTime(), nullable=True),
    sa.Column('clicks', sa.Integer(), nullable=True, server_default='0'), # MODIFIED
    ...
    sa.UniqueConstraint('name', name=op.f('uq_custom_script_name')) # MODIFIED
    )
    ...
    sa.Column('reward_amount', sa.Float(), nullable=False, server_default='0.0'), # MODIFIED
    sa.Column('target_countries', sa.Text(), nullable=True),
    sa.Column('target_devices', sa.Text(), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=True, server_default=sa.true()), # MODIFIED (model default is True)
    sa.Column('creation_date', sa.DateTime(), nullable=True),
    sa.Column('image_filename', sa.String(length=256), nullable=True),
    sa.Column('is_daily', sa.Boolean(), nullable=False, server_default=sa.false()), # MODIFIED
    ...
    sa.Column('balance', sa.Float(), nullable=True, server_default='0.0'), # MODIFIED
    sa.Column('referral_code', sa.String(length=16), nullable=True),
    sa.Column('is_admin', sa.Boolean(), nullable=False, server_default=sa.false()), # MODIFIED (model default False, nullable False)
    sa.Column('is_super_admin', sa.Boolean(), nullable=False, server_default=sa.false()), # MODIFIED
    sa.Column('last_withdrawal_date', sa.DateTime(), nullable=True),
    sa.Column('is_banned', sa.Boolean(), nullable=False, server_default=sa.false()), # MODIFIED
    sa.Column('referred_by_id', sa.Integer(), nullable=True),
    sa.Column('completed_task_count', sa.Integer(), nullable=False, server_default='0'), # MODIFIED
    sa.Column('telegram_username', sa.String(length=100), nullable=True),
    sa.Column('is_verified', sa.Boolean(), nullable=False, server_default=sa.false()), # MODIFIED
    sa.ForeignKeyConstraint(['referred_by_id'], ['user.id'], name=op.f('fk_user_referred_by_id_user')), # MODIFIED
    sa.PrimaryKeyConstraint('id', name=op.f('pk_user')),
    sa.UniqueConstraint('referral_code', name=op.f('uq_user_referral_code')) # MODIFIED
    )
    ...
    sa.Column('status', sa.String(length=20), nullable=True, server_default='Pending'), # MODIFIED
    ...
    sa.ForeignKeyConstraint(['processed_by_admin_id'], ['user.id'], name=op.f('fk_external_task_completion_processed_by_admin_id_user')), # MODIFIED
    sa.ForeignKeyConstraint(['referrer_user_id'], ['user.id'], name=op.f('fk_external_task_completion_referrer_user_id_user')), # MODIFIED
    sa.ForeignKeyConstraint(['task_id'], ['task.id'], name=op.f('fk_external_task_completion_task_id_task')), # MODIFIED
    ...
    sa.Column('is_read', sa.Boolean(), nullable=True, server_default=sa.false()), # MODIFIED (model default is False)
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_notification_user_id_user')), # MODIFIED
    ...
    sa.Column('image_filename', sa.String(length=256), nullable=True),
    sa.Column('allow_comments', sa.Boolean(), nullable=False, server_default=sa.true()), # MODIFIED
    sa.Column('is_published', sa.Boolean(), nullable=False, server_default=sa.false()), # MODIFIED
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_post_user_id_user')), # MODIFIED
    ...
    sa.ForeignKeyConstraint(['task_id'], ['task.id'], name=op.f('fk_user_task_completion_task_id_task')), # MODIFIED
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_user_task_completion_user_id_user')), # MODIFIED
    ...
    sa.Column('status', sa.String(length=20), nullable=True, server_default='Pending'), # MODIFIED
    sa.Column('processed_by_admin_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['processed_by_admin_id'], ['user.id'], name=op.f('fk_withdrawal_processed_by_admin_id_user')), # MODIFIED
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_withdrawal_user_id_user')), # MODIFIED
    ...
    sa.Column('is_approved', sa.Boolean(), nullable=False, server_default=sa.true()), # MODIFIED
    sa.Column('parent_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['parent_id'], ['comment.id'], name=op.f('fk_comment_parent_id_comment')), # MODIFIED
    sa.ForeignKeyConstraint(['post_id'], ['post.id'], name=op.f('fk_comment_post_id_post')), # MODIFIED
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_comment_user_id_user')), # MODIFIED
    ...
    sa.Column('status', sa.String(length=20), nullable=False, server_default='Pending'), # MODIFIED
    sa.Column('creation_timestamp', sa.DateTime(), nullable=True),
    sa.Column('processed_timestamp', sa.DateTime(), nullable=True),
    sa.Column('processed_by_admin_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['originating_completion_id'], ['user_task_completion.id'], name=op.f('fk_referral_commission_originating_completion_id_user_task_completion')), # MODIFIED
    sa.ForeignKeyConstraint(['processed_by_admin_id'], ['user.id'], name=op.f('fk_referral_commission_processed_by_admin_id_user')), # MODIFIED
    sa.ForeignKeyConstraint(['referred_user_id'], ['user.id'], name=op.f('fk_referral_commission_referred_user_id_user')), # MODIFIED
    sa.ForeignKeyConstraint(['referrer_id'], ['user.id'], name=op.f('fk_referral_commission_referrer_id_user')), # MODIFIED
    sa.PrimaryKeyConstraint('id', name=op.f('pk_referral_commission')),
    sa.UniqueConstraint('originating_completion_id', name=op.f('uq_referral_commission_originating_completion_id')) # MODIFIED
    )
